...
export const metadata: Metadata = {
  title: 'Inscrição enviada — Lakehouse: Pipeline na Prática | Azuris',
    ...
    <main className="min-h-screen bg-[var(--azuris-ink)] text-[var(--text-primary)] flex items-center">
      <div className="mx-auto max-w-xl px-4 py-12 text-center">
        ...
        <p className="mt-4 text-[var(--text-secondary)] leading-relaxed">
          Recebemos sua inscrição no <strong className="text-[var(--text-primary)]">Lakehouse: Pipeline na Prática</strong>.
          Assim que o pagamento for confirmado, você recebe um e-mail com os próximos passos (link do Discord, calendário das aulas, material de boas-vindas).
        </p>
        ...
        <div className="mt-8 rounded-2xl border border-[var(--azuris-surface)] bg-[var(--azuris-deep)] p-6 text-left text-sm">
          ...
          <ul className="space-y-2 text-[var(--text-secondary)]">
            ...
            <li className="flex gap-2">
              ...
              <span>Em até 2 dias úteis após o pagamento confirmado, você recebe o convite do Discord e o calendário das aulas.</span>
            </li>
          </ul>
        </div>
