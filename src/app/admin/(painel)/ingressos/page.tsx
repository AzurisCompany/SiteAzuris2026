...
// Produtos cujo checkout consome o catálogo de tipos. Hoje: DSSBR.
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-[var(--text-muted)]">
          Cadastre as variantes de um produto (ex.: Estudante, Profissional, VIP, Corporativo). O checkout do DSSBR mostra
          os tipos <strong>ativos</strong> e cobra o valor que você definir aqui. Sem nenhum tipo, o checkout usa o preço único padrão.
        </p>
      </div>
